...
const TagSearch = () => {
	...
	const [keyword, setKeyword] = useState(
		decodeURI(window.location.pathname.replace("/tagSearch/", "")).replace(
			"분위기",
			""
		) + window.location.search.replace("?click=", "")
	);
	...
	useEffect(() => {
		...
		document
			?.querySelector(
				"#tag__search > div > div.tag__search > ul.tag__list > li"
			)
			?.classList.add("active");
