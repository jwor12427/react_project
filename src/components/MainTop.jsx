...
const candidate = ["버즈", "VOS", "SG워너비", "씨야", "가비앤제이", "다비치"];
...
const MainTop = () => {
	...
	useEffect(() => {
		...
		let reqOptions = {
			url: `https://youtube-music1.p.rapidapi.com/v2/search?query=${
